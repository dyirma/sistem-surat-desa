...
<div style="margin-bottom: 24px;">
    <h1 style="font-size: 24px; font-weight: 600; margin-bottom: 5px;">Tambah Template Baru</h1>
    <p class="text-muted">Buat format dasar surat untuk jenis layanan baru.</p>
</div>
    ...
    <form action="{{ route('template-surat.store') }}" method="POST">
        ...
        <div style="display: flex; gap: 20px;">
            <div class="form-group" style="flex: 1;">
                <label>Jenis Surat (Kode Unik) <span style="color: red;">*</span></label>
                <input type="text" name="jenis_surat" class="form-control" value="{{ old('jenis_surat') }}" placeholder="Contoh: izin-keramaian" required>
                <small style="color: #64748b; display: block; margin-top: 5px;">Hanya huruf kecil, angka, dan tanda hubung (-). Tanpa spasi.</small>
            </div>
            <div class="form-group" style="flex: 2;">
                <label>Nama Template <span style="color: red;">*</span></label>
                <input type="text" name="nama_template" class="form-control" value="{{ old('nama_template') }}" placeholder="Contoh: Surat Izin Keramaian" required>
            </div>
        </div>

        <div class="form-group">
            <label>Deskripsi Singkat</label>
            <input type="text" name="deskripsi" class="form-control" value="{{ old('deskripsi') }}" placeholder="Penjelasan kegunaan surat ini untuk warga...">
        </div>
