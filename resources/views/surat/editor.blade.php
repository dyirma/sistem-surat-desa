...
<div class="dashboard-card">
    <form action="{{ route('surat.printFinal') }}" method="POST" id="editorForm">
        ...
        <input type="hidden" name="format_ttd" value="{{ $validated['format_ttd'] ?? '1' }}">
...
<script>
    tinymce.init({
        ...
        content_style: `
            body { font-family: 'Times New Roman', Times, serif; font-size: 12pt; line-height: 1.5; color: black; text-align: justify; }
