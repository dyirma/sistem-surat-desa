...
<head>
    ...
    <style>
        ...
        .kop-surat h1 { font-size: 14pt; margin: 0; text-transform: uppercase; font-weight: normal; }
    ...
    <div class="page">
        ...
        <div class="kop-surat">
            @if($pengaturan && $pengaturan->logo_path)
                <img src="{{ asset($pengaturan->logo_path) }}" alt="Logo" style="width: 2.5cm; position: absolute; left: 0; top: 0;">
            @endif
        ...
        <div class="judul-surat">
            ...
            @if($surat->jenis_surat === 'pengantar')
                <div style="text-align: left; font-size: 11pt; margin-top: -10px; margin-bottom: 20px;">
