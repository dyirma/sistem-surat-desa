...
<div class="dashboard-card">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px; margin-top: 30px;">
        <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 20px; padding: 20px;">
            ...
            <a href="{{ route('surat.index') }}" style="display: inline-block; padding: 8px 16px; background: var(--primary-color); color: white; text-decoration: none; border-radius: 50px; font-size: 14px; font-weight: 500;">Buat Surat</a>
        </div>
        ...
        <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 20px; padding: 20px;">
            ...
            <a href="{{ route('penduduk.index') }}" style="display: inline-block; padding: 8px 16px; background: var(--primary-color); color: white; text-decoration: none; border-radius: 50px; font-size: 14px; font-weight: 500;">Lihat Data</a>
        </div>
    </div>
</div>
@endsection
